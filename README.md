...
## Major Update: v1.4.2 is out which includes lots of new features + still supports most old/new Surface UI
...
| `SurfaceChargingTray-v1.4.2-x64.zip` | Intel-based Surfaces (most common). Also runs on Snapdragon via Prism emulation. |
