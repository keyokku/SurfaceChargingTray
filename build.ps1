...
$dist       = Join-Path $root 'dist\v1.2.2'
...
if ($Arch -eq 'all') {
    ...
    $stage = Join-Path $root 'release-staging\v1.2.2\diagnostic'
    ...
    $zipOut = Join-Path $root 'release-staging\v1.2.2\SurfaceChargingTrayDiagnostic.zip'
